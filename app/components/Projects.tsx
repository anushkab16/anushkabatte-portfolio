...
const PROJECTS = [
  ...
  },
  {
    ...
    card: { top: '48px', left: '35%', rotate: 2 },
  },
  {
    id: 'wildfire',
  ...
  },
  {
    ...
    card: { bottom: '0px', left: '10%', rotate: 3 },
  },
]
...
function ProjectCardInner({ project }: { project: Project }) {
  return (
    ...
    >
      ...
      <div className="p-4">
        <div className="font-display text-[17px] font-bold text-text">{project.name}</div>
        ...
        <div className="p-6">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border px-5 py-2.5 text-[13px] font-medium text-text transition-colors hover:bg-white/5"
              style={{ borderColor: 'rgba(232,217,193,0.16)' }}
            >
              Read More &rarr;
            </a>
          </div>
        ...
        <div className="relative mx-auto mt-20 h-[560px] max-w-5xl">
          {PROJECTS.map((project) => (
            <motion.button
              ...
              initial={{ rotate: project.card.rotate }}
              whileHover={{ rotate: 0, scale: 1.03, y: -6 }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="absolute z-0 w-[260px] cursor-pointer text-left hover:z-10"
              style={{
                top: 'top' in project.card ? project.card.top : undefined,
                bottom: 'bottom' in project.card ? project.card.bottom : undefined,
                left: 'left' in project.card ? project.card.left : undefined,
                right: 'right' in project.card ? project.card.right : undefined,
              }}
            >
